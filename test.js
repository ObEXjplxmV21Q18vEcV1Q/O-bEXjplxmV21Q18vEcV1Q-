 ...
 * Source: Yemasthui (basicBot) - https://goo.gl/N2JQVJ (original source!)
 * Copyright © 2015!
 * ♥
 */

var password = "coolermaster07012001"

var x = prompt("Ukucaj šifru za pokretanje ST ARMY BOT-a!"," ")

if (x.toLowerCase() == password) {
alert("Šifra tačna, pokretanje...");
...
(function () {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/pickorita/ST-BOT/master/stbot.js",
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.autoskip) {
                ...
                basicBot.room.autoskipTimer = setTimeout(function() {
                    ...
                    if (startcid === endcid) {
                        API.sendChat("Pesma je ubagovala! :fast_forward:");
                        API.moderateForceSkip();
                    }
                }, remaining + 5000);
            }
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                if(msg.indexOf("@ST ARMY BOT :rainbowfrog:") !== -1 || msg.indexOf("aezhahjt") !== -1){                
                ...
                if(msg.indexOf("@ST ARMY BOT :rmmelon:") !== -1 || msg.indexOf("dhsdhWG") !== -1){                
                  var RespondMsg = [":rmmelon:"];
                 API.sendChat("@" + chat.un + " " + RespondMsg[Math.floor(Math.random() * RespondMsg.length)]);
                }
                if(msg.indexOf("@ST ARMY BOT :rmbiscuit:") !== -1 || msg.indexOf("ehadehaeh") !== -1){                
                ...
                if(msg.indexOf("Dobrodošao/la") !== -1 || msg.indexOf("Dobrodošao/la nazad") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                    }, 60 * 1000, chat.cid);
                }
                ...
                if(msg.indexOf("@undefined") !== -1 || msg.indexOf("!dudu") !== -1 || msg.indexOf("!reload") !== -1 || msg.indexOf("!refresh") !== -1 || msg.indexOf("!watermelons") !== -1 || msg.indexOf("!fire") !== -1 || msg.indexOf("!tuc") !== -1 || msg.indexOf("!hearts") !== -1 || msg.indexOf("undefined") !== -1){
                 API.moderateDeleteChat(chat.cid);	
                }
                if(msg.indexOf("AutoWoot:https://goo.gl/vK1SnK") !== -1 || msg.indexOf("https://goo.gl/UGXoKK") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                    }, 59 * 1000, chat.cid);
                }
                if(msg.indexOf("ne vidim tvoje isključenje!") !== -1 || msg.indexOf("nisi bio/la u listi čekanja!") !== -1 || msg.indexOf("ti si se isključio/la pre") !== -1 || msg.indexOf("ti si se poslednji put isključio/la pre") !== -1 || msg.indexOf("Pesma je ubagovala!") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                    }, 10 * 1000, chat.cid);
                }
                if(msg.indexOf("ulul7zl") !== -1 || msg.indexOf("@djs Rulet je pokrenut! Kucajte !join ako želite da učestvujete!") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                 }, 31 * 1000, chat.cid);
                }
                if(msg.indexOf("asehajhaj") !== -1 || msg.indexOf("span class") !== -1 || msg.indexOf("zjrdqd") !== -1){                
                 API.moderateDeleteChat(chat.cid);
                }
                ...
                if ((msg.indexOf("Dobrodošao/la u rulet") > -1 || msg.indexOf("Napustio/la si rulet") > -1) && chat.uid === basicBot.loggedInID) {
                    setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                    }, 7 * 1000, chat.cid);
                    return true;
        ...
        startup: function () {
            ...
            /*setTimeout(function (id) {
                            $.getScript(basicBot.scriptLink2);
                        }, 10 * 1000, chat.cid);*/        
        },
        commands: {
            ...
            hourbanCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var user = basicBot.userUtilities.lookupUserName(name);
                        if (typeof user === 'boolean') return API.sendChat(subChat(basicBot.chat.invaliduserspecified, {name: chat.un}));
                        API.sendChat(subChat(basicBot.chat.hban, {name: chat.un}));
            ...
            daybanCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var user = basicBot.userUtilities.lookupUserName(name);
                        if (typeof user === 'boolean') return API.sendChat(subChat(basicBot.chat.invaliduserspecified, {name: chat.un}));
                        API.sendChat(subChat(basicBot.chat.dban, {name: chat.un}));
            ...
            permabanCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var user = basicBot.userUtilities.lookupUserName(name);
                        if (typeof user === 'boolean') return API.sendChat(subChat(basicBot.chat.invaliduserspecified, {name: chat.un}));
                        API.sendChat(subChat(basicBot.chat.pban, {name: chat.un}));
            ...
            englishCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var ch = ' @' + name + ' ';
                        switch(lang){}
                        ch += ' Please speak only English or Serbian!';
                        API.sendChat(ch);
                    }
                }
            },
            ...
            dieCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        storeToStorage();
                        sendToSocket();
                        API.sendChat(basicBot.chat.die);
                        basicBot.disconnectAPI();
                        setTimeout(function () {
                            kill();
                        }, 1000);
            ...
            disableCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.chatLog("Gašenje AFK PORUKE,AUTO JOIN-a")
...
alert("Šifra netačna, pokušaj ponovo!")
}
